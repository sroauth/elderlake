...
import Schema from "../islands/Schema.tsx";
    ...
    <>
      ...
      <div class="w-screen h-screen">
        <div class="flex justify-between items-center p-8">
          <div class="flex items-center gap-3 text-[#D08770]">
            <svg
              width="32"
              height="32"
              viewBox="0 0 759 792"
            ...
            <span class="text-transform text-uppercase tracking-widest text-xl font-medium">
              Elderlake
            </span>
          </div>
